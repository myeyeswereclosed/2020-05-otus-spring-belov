package ru.otus.spring.spring_shell_testing_app.analyzer;
...
import ru.otus.spring.spring_shell_testing_app.service.analyzer.AnswersAnalyzer;
import ru.otus.spring.spring_shell_testing_app.service.analyzer.TestAnalyzerImpl;
...
public class TestAnalyzerTest {
    ...
    private final static StudentTest STUDENT_TEST_STUB =
        new StudentTest(
            ...
            new ru.otus.spring.spring_shell_testing_app.domain.Test("Mock test", Collections.emptyList()),
